export interface IAlertTag {
  ...
  strength?: 'Low' | 'Medium' | 'High' | 'Insane'; // The Attack Strength for this set of rules, default: Medium
  threshold?: 'Off' | 'Low' | 'Medium' | 'High'; // The Alert Threshold for this set of rules, default: Medium
}
...
export interface IRule {
  ...
  strength?: 'Low' | 'Medium' | 'High' | 'Insane'; // The Attack Strength for this rule, default: Medium
...
export interface IActiveScanPolicyParameters {
  ...
  policyDefinition: {
    defaultStrength?: 'Low' | 'Medium' | 'High' | 'Insane'; // Default Attack Strength for all rules, default: Medium
    defaultThreshold?: 'Off' | 'Low' | 'Medium' | 'High'; // Default Alert Threshold for all rules, default: Medium
